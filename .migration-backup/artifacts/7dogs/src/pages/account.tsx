...
import { UserRound, Gift, ShoppingBag, ShieldAlert } from "lucide-react";
...
export default function AccountPage() {
  ...
  const avatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.firstName || user.username || "U")}&background=1a1a1a&color=D4AF37&size=128&bold=true`;
